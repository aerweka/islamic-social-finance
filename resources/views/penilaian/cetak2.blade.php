...
<body>
    <center><p style="font-size: 30px; font-weight: bold">Hasil Pengukuran {{Carbon::parse($jawaban[0]->filled_at)->year}}</p></center>
    ...
    <table class="table table-bordered col-md-8 offset-md-2" style="line-height: 10px; font-size: 13px">
        <thead class="thead-dark">
            <tr>
                ...
                <th>Dimensi</th>
                <th>Aspek</th>
                <th>Nilai(hasil jumlah nilai akhir)</th>
                <!-- <th>Nilai Total</th> -->
            </tr>
        </thead>
        <tbody>
    ...
    <table class="table table-bordered col-md-8 offset-md-2" style="line-height: 10px">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="2" style="text-align: center; background-color: #69DC84">Nilai Total Kinerja: {{$jawaban[0]->total_all}}%</td>
            </tr>
        </tbody>
    </table>
</body>
